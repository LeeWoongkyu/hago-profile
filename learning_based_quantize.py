...
parser.add_argument('--debug', required=False, default=False, help='use debugger')
parser.add_argument('--dtype', required=False, default='fp32', help='fp32 or int8')
...
if __name__ == "__main__":
    ...
    rec_val = "/home/woongkyu/imagenet/val.rec"
